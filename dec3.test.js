const {rucksackList, itemPriority, outOfPlace, prioritizedTotal, groupList, groupBadgeLetter} = require('./dec3');
...
const expectedOutput = [['vJrwpWtwJgWr','hcsFMMfFFhFp'],
...
const expectedGroupOutput = [['vJrwpWtwJgWrhcsFMMfFFhFp',
'jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL',
'PmmdzqPrVvPwwTWBwg'],
['wMqvLMZHhHMvwLHjbvcjnnSBnvTQFn',
'ttgJtRGJQctTZtZT',
